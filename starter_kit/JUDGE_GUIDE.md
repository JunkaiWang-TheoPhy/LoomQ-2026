...
| 区域 | 一条复核命令 | 主要证据 |
|---|---|---|
| 全部无凭据路径 | `python3 starter_kit/verify_submission.py` | 78 项归档回归、L2 固定语料、真机 manifest、L1/L3/RISC-V |
...
| L2 体验 | `python3 -m starter_kit.loomq.web` | Learn / Build / Repair / Backend Match、逐门状态故事、受限多轮上下文、桌面/移动端验收、`WEB_QA.md` |
